...
export const filesApi = {
  async list(params: PaginationParams = {}): Promise<PageResponse<WorkspaceFileResponse>> {
...
export const datasetsApi = {
  async list(params: PaginationParams & { project_id?: string } = {}): Promise<PageResponse<DatasetResponse>> {
    const response = await apiClient.get<PageResponse<DatasetResponse>>("/datasets", { params });
    return response.data;
  },

  async create(payload: { project_id: string; file_id: string; dataset_type: DatasetType }): Promise<DatasetResponse> {
