...
from app.modules.projects.router import admin_router as admin_projects_router
...
from app.modules.users.router import organization_router
...
api_router.include_router(admin_reports_router, prefix="/admin/reports", tags=["admin-reports"])
